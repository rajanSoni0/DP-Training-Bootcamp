...
vector<int> merge_vec(const vector<int>& left, const vector<int>& right) {
    int l = 0, r = 0;
...
void build(int idx, int l, int r) {
    ...
    tree[idx] = merge_vec(tree[2 * idx + 1], tree[2 * idx + 2]);
}

// count numbers > k in range [ql, qr]
